                ...
                <div class="w-full ">
                    ...
                    <div class="containre-product w-[73.125rem] px-5 m-auto max-lg:w-[46rem]  max-w-full mt-[30px] ">
                        ...
                        <div class="product mt-[30px]  z-0">
                            <div
                                class="product1 grid grid-cols-4 gap-8 max-lg:grid-cols-3 max-sm:grid-cols-2 transition-all ease-out duration-500 mt-10 mb-10" id="product1">
                            ...
                            <div class="mt-10">
                                ...
                                ">
                                    ...
                                    <span
                                        class="flex justify-center items-center text-[14px] text-gray-400 font-LibreBaskerville font-normal italic">Top sale in this week</span>
                                </div>
                                <div class="product grid grid-cols-4 gap-8 max-lg:grid-cols-3 max-sm:grid-cols-2 transition-all ease-out duration-500 mt-10 mb-10" id="bestSeller">
                                </div>
                            </div>
                        </div>
                    </div>
